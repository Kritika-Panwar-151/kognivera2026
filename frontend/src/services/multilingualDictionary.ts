...
export const CATEGORY_DICTIONARY: Record<CanonicalCategory, {
  ...
  Food: {
    en: ['food', 'eating', 'eat', 'dinner', 'lunch', 'breakfast', 'coffee', 'meal', 'cafe', 'restaurant', 'pizza', 'gelato', 'beer', 'drinks', 'snack', 'wine', 'trattoria', 'swiggy', 'zomato'],
  ...
  Transport: {
    en: ['transport', 'travel', 'commute', 'ride', 'drive', 'fare', 'transit', 'metro', 'train', 'cab', 'taxi', 'uber', 'bus', 'flight', 'ticket', 'gas', 'petrol', 'diesel', 'fuel', 'toll', 'tram', 'ferry', 'auto', 'rickshaw'],
    hi: ['transport', 'kiraya', 'auto', 'rickshaw', 'safar', 'ticket', 'gaadi', 'petrol', 'diesel', 'metro', 'train', 'bus', 'gadi'],
    it: ['trasporto', 'treno', 'metro', 'biglietto', 'taxi', 'autobus', 'volo', 'traghetto', 'benzina'],
    es: ['transporte', 'metro', 'tren', 'billete', 'coche', 'taxi', 'vuelo', 'autobús', 'gasolina'],
    fr: ['transport', 'métro', 'train', 'billet', 'taxi', 'bus', 'vol', 'essence'],
  },
  Accommodation: {
    en: ['accommodation', 'stay', 'lodging', 'hotel', 'hostel', 'airbnb', 'room', 'checkout', 'resort', 'villa', 'lodge'],
    hi: ['accommodation', 'kamra', 'hotel', 'stay', 'rukna', 'lodge'],
    it: ['alloggio', 'albergo', 'hotel', 'camera', 'soggiorno', 'ostello'],
    es: ['alojamiento', 'hotel', 'habitación', 'estancia', 'hostal'],
    fr: ['logement', 'hôtel', 'chambre', 'séjour', 'auberge'],
  },
  Activities: {
    en: ['activities', 'activity', 'sightseeing', 'museum', 'entry', 'monument', 'colosseum', 'tour', 'ticket', 'guide', 'pass', 'vatican', 'event'],
    hi: ['activity', 'darshan', 'tour', 'ghoomna', 'kila', 'mandir', 'entry pass', 'museum'],
    it: ['attività', 'museo', 'monumento', 'colosseo', 'guida', 'biglietto d’ingresso', 'vaticano'],
    es: ['actividades', 'museo', 'monumento', 'entrada', 'visita guiada', 'excursión'],
    fr: ['activités', 'musée', 'monument', 'visite', 'billet d’entrée', 'guide'],
  },
  Shopping: {
    en: ['shopping', 'souvenir', 'clothes', 'gifts', 'market', 'mall', 'shoes', 'bag', 'store', 'bought', 'buy'],
    hi: ['shopping', 'kharidari', 'kapde', 'samaana', 'tohfa', 'bazaar'],
    it: ['shopping', 'regali', 'souvenir', 'vestiti', 'spesa al mercato', 'acquisti'],
    es: ['compras', 'recuerdos', 'ropa', 'mercado', 'tienda'],
    fr: ['shopping', 'souvenirs', 'vêtements', 'achats', 'marché', 'cadeaux'],
  },
  Other: {
    en: ['other', 'misc', 'general', 'tip', 'donation'],
    hi: ['other', 'baki', 'anya', 'kharcha'],
